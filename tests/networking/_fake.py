...
class FakeNetworkingAPI:
    """Stateful Networking v1 boundary for all supported resources."""
    ...
    def __call__(self, request: httpx2.Request) -> httpx2.Response:
        ...
        if parts[3] == "namespaces":
            ...
            all_namespaces = resource in {"ingresses", "networkpolicies"}
                        ...
                        "ingress": [
                            {
                                ...
                                "ip": "192.0.2.10",
                                "ports": [{"port": 443, "protocol": "TCP", "error": "pending"}],
                            }
                        ]
                    }
                }

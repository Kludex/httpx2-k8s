...
def test_cluster_and_namespaced_custom_objects_through_httpx2() -> None:
    ...
    with KubeClient(
        ...
        cluster = client.custom_objects.create_cluster_custom_object(
            group,
            "v1",
            "clusterwidgets",
        ...
        assert (
            client.custom_objects.read_cluster_custom_object(
                group,
                "v1",
                "clusterwidgets",
                "global widget",
        ...
        assert (
            client.custom_objects.read_cluster_custom_object_subresource(
                group,
                "v1",
                "clusterwidgets",
                "global widget",
        ...
        cluster = client.custom_objects.replace_cluster_custom_object_subresource(
            group,
            "v1",
            "clusterwidgets",
            "global widget",
        ...
        cluster = client.custom_objects.patch_cluster_custom_object_subresource(
            group,
            "v1",
            "clusterwidgets",
            "global widget",
        ...
        cluster = client.custom_objects.replace_cluster_custom_object(
            group, "v1", "clusterwidgets", "global widget", cluster
        )
        assert cluster.model_extra is not None
        assert cast(dict[str, object], cluster.model_extra["spec"])["replicas"] == 3
        cluster = client.custom_objects.patch_cluster_custom_object(
            group,
            "v1",
            "clusterwidgets",
            "global widget",
        ...
        cluster = client.custom_objects.apply_cluster_custom_object(
            group,
            "v1",
            "clusterwidgets",
            "global widget",
        ...
        clusters = client.custom_objects.list_cluster_custom_object(
            group,
            "v1",
            "clusterwidgets",
        ...
        client.custom_objects.create_cluster_custom_object(
            group,
            "v1",
            "clusterwidgets",
            Unstructured.model_validate(
        ...
        dry_run_clusters = client.custom_objects.delete_collection_cluster_custom_object(
            group,
            "v1",
            "clusterwidgets",
        ...
        deleted_clusters = client.custom_objects.delete_collection_cluster_custom_object(
            group,
            "v1",
            "clusterwidgets",
        ...
        assert (
            client.custom_objects.read_namespaced_custom_object_subresource(
                group,
                "v1",
                "team one",
                "widgets",
        ...
        widget = client.custom_objects.replace_namespaced_custom_object_subresource(
            group,
            "v1",
            "team one",
            "widgets",
        ...
        widget = client.custom_objects.patch_namespaced_custom_object_subresource(
            group,
            "v1",
            "team one",
            "widgets",
...
def test_json_patch_serializes_from_alias() -> None:
    patch = JsonPatch(
        operations=[
            JsonPatchOperation(op="copy", path="/metadata/labels/new", from_="/metadata/name")
        ]
    )
    assert json.loads(patch.wire_json()) == [
        {"op": "copy", "path": "/metadata/labels/new", "from": "/metadata/name"}
    ]

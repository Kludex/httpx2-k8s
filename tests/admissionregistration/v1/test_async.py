...
@pytest.mark.anyio
async def test_all_async_admissionregistration_v1_lifecycles_through_httpx2() -> None:
    ...
    async with AsyncKubeClient(
        ...
        api: AsyncAdmissionRegistrationV1API = client.admissionregistration_v1
        assert api is client.admissionregistration_v1

        mutating = await api.create_mutating_webhook_configuration(
            MutatingWebhookConfiguration(
        ...
        assert (await api.read_mutating_webhook_configuration("mutator config")) == mutating
        mutating = await api.apply_mutating_webhook_configuration(
            "mutator config",
            mutating,
            field_manager="admission-tests",
            force=True,
        )
        mutating = await api.replace_mutating_webhook_configuration(
            "mutator config",
            mutating,
            field_manager="admission-tests",
            dry_run="All",
        )
        mutating = await api.patch_mutating_webhook_configuration(
            "mutator config",
            MergePatch(document={"metadata": {"annotations": {"patched": "mutating"}}}),
            dry_run="All",
        )
        assert mutating.metadata.annotations == {"patched": "mutating"}
        mutating_list = await api.list_mutating_webhook_configuration(
        ...
        deleted_mutating = await api.delete_collection_mutating_webhook_configuration(
        ...
        assert (
            await api.delete_mutating_webhook_configuration("mutator config")
        ).status == "Success"

        validating = await api.create_validating_webhook_configuration(
            ValidatingWebhookConfiguration(
        ...
        assert (await api.read_validating_webhook_configuration("validator config")) == validating
        validating = await api.apply_validating_webhook_configuration(
            "validator config",
            validating,
            field_manager="admission-tests",
            force=False,
        ...
        validating = await api.replace_validating_webhook_configuration(
            "validator config",
            validating,
            field_manager="admission-tests",
        )
        validating = await api.patch_validating_webhook_configuration(
            "validator config",
            MergePatch(document={"metadata": {"annotations": {"patched": "validating"}}}),
        )
        assert validating.metadata.annotations == {"patched": "validating"}
        assert (await api.list_validating_webhook_configuration()).items == [validating]
        deleted_validating = await api.delete_collection_validating_webhook_configuration(
        ...
        assert (
            await api.delete_validating_webhook_configuration("validator config")
        ).status == "Success"
        ...
        policy = await api.create_validating_admission_policy(
            ValidatingAdmissionPolicy(
        ...
        assert (await api.read_validating_admission_policy("config policy")) == policy
        policy = await api.apply_validating_admission_policy(
            "config policy",
            policy,
            field_manager="admission-tests",
        )
        policy = await api.replace_validating_admission_policy(
            "config policy",
            policy,
            field_manager="admission-tests",
            dry_run="All",
        )
        policy = await api.patch_validating_admission_policy(
            "config policy",
            MergePatch(document={"metadata": {"annotations": {"patched": "policy"}}}),
            field_manager="admission-tests",
        )
        assert policy.metadata.annotations == {"patched": "policy"}
        assert (await api.list_validating_admission_policy()).items == [policy]
        policy_status = await api.read_validating_admission_policy_status("config policy")
        policy_status = await api.patch_validating_admission_policy_status(
            "config policy",
        ...
        policy = await api.replace_validating_admission_policy_status(
            "config policy",
            policy_status,
            field_manager="admission-tests",
        )
        ...
        binding = await api.create_validating_admission_policy_binding(
            ValidatingAdmissionPolicyBinding(
        ...
        assert (await api.read_validating_admission_policy_binding("config binding")) == binding
        binding = await api.apply_validating_admission_policy_binding(
            "config binding",
            binding,
            field_manager="admission-tests",
            force=True,
        ...
        binding = await api.replace_validating_admission_policy_binding(
            "config binding",
            binding,
            field_manager="admission-tests",
        )
        binding = await api.patch_validating_admission_policy_binding(
            "config binding",
        ...
        assert (await api.list_validating_admission_policy_binding()).items == [binding]
        deleted_bindings = await api.delete_collection_validating_admission_policy_binding(
        ...
        assert (
            await api.delete_validating_admission_policy_binding("config binding")
        ).status == "Success"
        deleted_policies = await api.delete_collection_validating_admission_policy(
        ...
        assert (await api.delete_validating_admission_policy("config policy")).status == "Success"
        ...
        mutating_policy = await api.create_mutating_admission_policy(
            MutatingAdmissionPolicy(
        ...
        assert (await api.read_mutating_admission_policy("label policy")) == mutating_policy
        mutating_policy = await api.apply_mutating_admission_policy(
            "label policy",
            mutating_policy,
            field_manager="admission-tests",
            force=True,
        )
        mutating_policy = await api.replace_mutating_admission_policy(
            "label policy",
            mutating_policy,
            field_manager="admission-tests",
            dry_run="All",
        )
        mutating_policy = await api.patch_mutating_admission_policy(
            "label policy",
            MergePatch(document={"metadata": {"annotations": {"patched": "mutation"}}}),
            field_manager="admission-tests",
        )
        assert mutating_policy.metadata.annotations == {"patched": "mutation"}
        assert (await api.list_mutating_admission_policy()).items == [mutating_policy]

        mutating_binding = await api.create_mutating_admission_policy_binding(
            MutatingAdmissionPolicyBinding(
        ...
        assert (
            await api.read_mutating_admission_policy_binding("label binding")
        ) == mutating_binding
        mutating_binding = await api.apply_mutating_admission_policy_binding(
            "label binding",
            mutating_binding,
            field_manager="admission-tests",
            force=False,
        ...
        mutating_binding = await api.replace_mutating_admission_policy_binding(
            "label binding",
            mutating_binding,
            field_manager="admission-tests",
        )
        mutating_binding = await api.patch_mutating_admission_policy_binding(
            "label binding",
            MergePatch(document={"metadata": {"annotations": {"patched": "binding"}}}),
            dry_run="All",
        )
        assert mutating_binding.metadata.annotations == {"patched": "binding"}
        assert (await api.list_mutating_admission_policy_binding()).items == [mutating_binding]
        deleted_mutating_bindings = await api.delete_collection_mutating_admission_policy_binding(
            DeleteOptions(dry_run=["All"]),
            label_selector="owner=tests",
        )
        assert [item.metadata.name for item in deleted_mutating_bindings.items] == ["label binding"]
        assert (
            await api.delete_mutating_admission_policy_binding("label binding")
        ).status == "Success"
        deleted_mutating_policies = await api.delete_collection_mutating_admission_policy(
            DeleteOptions(dry_run=["All"]),
            label_selector="owner=tests",
        )
        assert [item.metadata.name for item in deleted_mutating_policies.items] == ["label policy"]
        assert (await api.delete_mutating_admission_policy("label policy")).status == "Success"

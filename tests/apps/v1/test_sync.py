...
def test_apps_v1_controller_lifecycles_through_httpx2() -> None:
    ...
    with KubeClient(
        ...
        assert client.apps_v1.read_namespaced_deployment("web deployment", "team one") == deployment
        ...
        assert [
            item.metadata.name
            for item in client.apps_v1.delete_collection_namespaced_deployment(
                "team one",
        ...
        assert (
            client.apps_v1.delete_namespaced_deployment("web deployment", "team one").status
            == "Success"
        )
        ...
        assert client.apps_v1.read_namespaced_replica_set("web replicas", "team one") == replica_set
        ...
        assert client.apps_v1.list_namespaced_replica_set("team one").items == [replica_set]
        assert [
            item.metadata.name
            for item in client.apps_v1.delete_collection_namespaced_replica_set(
                "team one",
        ...
        assert (
            client.apps_v1.delete_namespaced_replica_set("web replicas", "team one").status
            == "Success"
        )
        ...
        assert client.apps_v1.read_namespaced_stateful_set("database", "team one") == stateful_set
        ...
        assert client.apps_v1.list_namespaced_stateful_set("team one").items == [stateful_set]
        assert [
            item.metadata.name
            for item in client.apps_v1.delete_collection_namespaced_stateful_set(
                "team one",
        ...
        assert (
            client.apps_v1.delete_namespaced_stateful_set("database", "team one").status
            == "Success"
        )
        ...
        assert client.apps_v1.read_namespaced_daemon_set("agent", "team one") == daemon_set
        ...
        assert client.apps_v1.list_namespaced_daemon_set("team one").items == [daemon_set]
        assert [
            item.metadata.name
            for item in client.apps_v1.delete_collection_namespaced_daemon_set(
                "team one",
                DeleteOptions(dry_run=["All"], orphan_dependents=False),
                label_selector="owner=tests",
            ).items
        ] == ["agent"]
        assert client.apps_v1.delete_namespaced_daemon_set("agent", "team one").status == "Success"
        ...
        assert client.apps_v1.read_namespaced_controller_revision("history", "team one") == revision
        ...
        assert client.apps_v1.list_namespaced_controller_revision("team one").items == [revision]
        assert [
            item.metadata.name
            for item in client.apps_v1.delete_collection_namespaced_controller_revision(
                "team one",
        ...
        assert (
            client.apps_v1.delete_namespaced_controller_revision("history", "team one").status
            == "Success"
        )

...
class FakeRBACAPI:
    """Stateful RBAC v1 boundary for roles and bindings."""
    ...
    def __call__(self, request: httpx2.Request) -> httpx2.Response:
        ...
        if parts[3] == "namespaces":
            ...
            all_namespaces = resource in {"rolebindings", "roles"}
        ...
        if request.method == "PUT":
            ...
            self.put_calls.append((resource, namespace, dict(request.url.params)))

...
class BatchV1API:
    """Typed Batch v1 Job and CronJob operations."""
    ...
    def read_namespaced_job_status(self, name: str, namespace: str) -> Job:
    ...
    def read_namespaced_cron_job_status(self, name: str, namespace: str) -> CronJob:
    ...
    def create_namespaced_job(self, namespace: str, body: Job) -> Job:
    ...
    def read_namespaced_job(self, name: str, namespace: str) -> Job:
    ...
    def delete_namespaced_job(self, name: str, namespace: str) -> Job:
    ...
    def create_namespaced_cron_job(self, namespace: str, body: CronJob) -> CronJob:
    ...
    def read_namespaced_cron_job(self, name: str, namespace: str) -> CronJob:
    ...
    def delete_namespaced_cron_job(self, name: str, namespace: str) -> Status:

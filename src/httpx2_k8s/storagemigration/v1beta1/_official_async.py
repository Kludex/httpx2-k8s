...
class _OfficialStorageMigrationV1Beta1AsyncOperations:
    ...
    async def delete_collection_storage_version_migration(
        ...
        *,
        ...
        _path = "/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations"
    ...
    async def delete_storage_version_migration(
        ...
        *,
        ...
        _path = (
            f"/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/{resource_name(name)}"
        )
        params = query_parameters(
            {
                "pretty": pretty,
    ...
    async def get_api_resources(
        ...
        _path = "/apis/storagemigration.k8s.io/v1beta1/"
        params = {}
        return await self._client.request(
            "GET",
            _path,
    ...
    async def list_storage_version_migration(
        ...
        *,
        ...
        return await self._client.request(
            "GET",
            _path,
            response_model=StorageMigrationV1Beta1StorageVersionMigrationList,
            params=params,
        )
    ...
    async def read_storage_version_migration(
        ...
        *,
        ...
        return await self._client.request(
            "GET",
            _path,
            response_model=StorageMigrationV1Beta1StorageVersionMigration,
            params=params,
        )
    ...
    async def read_storage_version_migration_status(
        ...
        *,
        ...
        _path = f"/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/{resource_name(name)}/status"
        params = query_parameters(
            {
                "pretty": pretty,
            }
    ...
    async def watch_storage_version_migration_list(
        self,
        *,
        allow_watch_bookmarks: bool | None = None,
        continue_token: str | None = None,
        ...
        _path = "/apis/storagemigration.k8s.io/v1beta1/watch/storageversionmigrations"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    def watch_storage_version_migration(
        self,
        name: str,
        *,
        allow_watch_bookmarks: bool | None = None,
        ...
        _path = f"/apis/storagemigration.k8s.io/v1beta1/watch/storageversionmigrations/{resource_name(name)}"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    async def create_storage_version_migration(
        self,
        body: StorageMigrationV1Beta1StorageVersionMigration,
        *,
        pretty: str | None = None,
        dry_run: str | None = None,
        field_manager: str | None = None,

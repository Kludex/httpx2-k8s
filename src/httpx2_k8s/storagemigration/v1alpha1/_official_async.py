...
class _OfficialStorageMigrationV1Alpha1AsyncOperations:
    ...
    async def delete_collection_storage_version_migration(
        ...
        *,
        ...
        _path = "/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations"
    ...
    async def delete_storage_version_migration(
        ...
        *,
        ...
        _path = (
            f"/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{resource_name(name)}"
        )
        params = query_parameters(
            {
                "pretty": pretty,
    ...
    async def get_api_resources(
        ...
        _path = "/apis/storagemigration.k8s.io/v1alpha1/"
        params = {}
        return await self._client.request(
            "GET",
            _path,
    ...
    async def list_storage_version_migration(
        ...
        *,
        ...
        return await self._client.request(
            "GET",
            _path,
            response_model=StorageMigrationV1Alpha1StorageVersionMigrationList,
            params=params,
        )
    ...
    async def read_storage_version_migration(
        ...
        *,
        ...
        return await self._client.request(
            "GET",
            _path,
            response_model=StorageMigrationV1Alpha1StorageVersionMigration,
            params=params,
        )
    ...
    async def read_storage_version_migration_status(
        ...
        *,
        ...
        _path = f"/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{resource_name(name)}/status"
        params = query_parameters(
            {
                "pretty": pretty,
            }
    ...
    async def watch_storage_version_migration_list(
        ...
        *,
        ...
        _path = "/apis/storagemigration.k8s.io/v1alpha1/watch/storageversionmigrations"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    def watch_storage_version_migration(
        ...
        *,
        ...
        _path = f"/apis/storagemigration.k8s.io/v1alpha1/watch/storageversionmigrations/{resource_name(name)}"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    async def create_storage_version_migration(
        self,
        body: StorageMigrationV1Alpha1StorageVersionMigration,
        *,
        pretty: str | None = None,
        dry_run: str | None = None,
        field_manager: str | None = None,

...
class _OfficialStorageV1Alpha1AsyncOperations:
    ...
    async def delete_collection_volume_attributes_class(
        ...
        *,
        ...
        _path = "/apis/storage.k8s.io/v1alpha1/volumeattributesclasses"
    ...
    async def delete_volume_attributes_class(
        ...
        *,
        ...
        _path = f"/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{resource_name(name)}"
        params = query_parameters(
            {
                "pretty": pretty,
                "dryRun": dry_run,
        ...
        return await self._client.request(
            "DELETE",
            _path,
            response_model=StorageV1Alpha1VolumeAttributesClass,
            params=params,
            body=body,
        )
    ...
    async def get_api_resources(
        ...
        _path = "/apis/storage.k8s.io/v1alpha1/"
        params = {}
        return await self._client.request(
            "GET",
            _path,
    ...
    async def list_volume_attributes_class(
        ...
        *,
        ...
        return await self._client.request(
            "GET",
            _path,
            response_model=StorageV1Alpha1VolumeAttributesClassList,
            params=params,
        )
    ...
    async def watch_volume_attributes_class_list(
        ...
        *,
        ...
        _path = "/apis/storage.k8s.io/v1alpha1/watch/volumeattributesclasses"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    def watch_volume_attributes_class(
        ...
        *,
        ...
        _path = f"/apis/storage.k8s.io/v1alpha1/watch/volumeattributesclasses/{resource_name(name)}"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    async def create_volume_attributes_class(
        self,
        body: StorageV1Alpha1VolumeAttributesClass,
        *,
        pretty: str | None = None,
        dry_run: str | None = None,
        field_manager: str | None = None,

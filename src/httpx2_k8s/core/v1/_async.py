...
class AsyncCoreV1API:
    """Asynchronous typed Core v1 operations, starting with Namespaces and Pods."""
    ...
    async def _read_status(self, path: str, *, response_model: type[ResourceT]) -> ResourceT:
        return await self._client.request("GET", f"{path}/status", response_model=response_model)
    ...
    async def create_namespace(self, body: Namespace) -> Namespace:
        """Create a Namespace."""
        return await self._client.request(
            "POST", "/api/v1/namespaces", response_model=Namespace, body=body
        )

    async def read_namespace(self, name: str) -> Namespace:
    ...
    async def delete_namespace(self, name: str) -> Namespace:
        """Delete a Namespace."""
        return await self._client.request(
    ...
    async def replace_namespace_status(self, name: str, body: Namespace) -> Namespace:
    ...
    async def read_namespace_status(self, name: str) -> Namespace:
    ...
    def watch_namespace(
        ...
        *,
        ...
        reconnect: bool = True,
        recover: bool = True,
    ) -> AsyncIterator[WatchEvent[Namespace] | WatchBookmark]:
        """Watch Namespaces with async bookmark and expired-version recovery."""
        relist: Callable[[], Awaitable[WatchPage]] | None = None
        if recover:

            async def relist_namespace() -> NamespaceList:
    ...
    async def read_component_status(self, name: str) -> ComponentStatus:
    ...
    async def create_node(self, body: Node) -> Node:
        """Create a cluster-scoped Node."""
        return await self._client.request("POST", "/api/v1/nodes", response_model=Node, body=body)

    async def read_node(self, name: str) -> Node:
    ...
    async def proxy_node(
        ...
        *,
        ...
        return await self._client.request_raw(
            method,
    ...
    async def replace_node_status(self, name: str, body: Node) -> Node:
    ...
    async def read_node_status(self, name: str) -> Node:
        """Read a Node through its status subresource."""
        return await self._read_status(f"/api/v1/nodes/{resource_name(name)}", response_model=Node)
    ...
    async def delete_node(self, name: str) -> Node | Status:
    ...
    async def create_namespaced_event(self, namespace: str, body: Event) -> Event:
    ...
    async def read_namespaced_event(self, name: str, namespace: str) -> Event:
    ...
    async def apply_namespaced_event(
        self,
        name: str,
        namespace: str,
        body: Event,
    ...
    async def delete_namespaced_event(self, name: str, namespace: str) -> Status:
    ...
    async def create_namespaced_limit_range(self, namespace: str, body: LimitRange) -> LimitRange:
    ...
    async def read_namespaced_limit_range(self, name: str, namespace: str) -> LimitRange:
    ...
    async def apply_namespaced_limit_range(
        self,
        name: str,
        namespace: str,
        body: LimitRange,
    ...
    async def delete_namespaced_limit_range(self, name: str, namespace: str) -> Status:
    ...
    async def read_namespaced_resource_quota(self, name: str, namespace: str) -> ResourceQuota:
    ...
    async def apply_namespaced_resource_quota(
        self,
        name: str,
        namespace: str,
        body: ResourceQuota,
    ...
    async def delete_namespaced_resource_quota(self, name: str, namespace: str) -> ResourceQuota:
    ...
    async def create_persistent_volume(self, body: PersistentVolume) -> PersistentVolume:
    ...
    async def read_persistent_volume(self, name: str) -> PersistentVolume:
    ...
    async def apply_persistent_volume(
        self,
        name: str,
        body: PersistentVolume,
        *,
    ...
    async def read_persistent_volume_status(self, name: str) -> PersistentVolume:
    ...
    async def delete_persistent_volume(self, name: str) -> PersistentVolume:
    ...
    async def apply_namespaced_persistent_volume_claim(
        self,
        name: str,
        namespace: str,
        body: PersistentVolumeClaim,
    ...
    async def create_namespaced_config_map(self, namespace: str, body: ConfigMap) -> ConfigMap:
    ...
    async def read_namespaced_config_map(self, name: str, namespace: str) -> ConfigMap:
    ...
    async def apply_namespaced_config_map(
        self,
        name: str,
        namespace: str,
        body: ConfigMap,
    ...
    async def delete_namespaced_config_map(self, name: str, namespace: str) -> Status:
    ...
    async def create_namespaced_secret(self, namespace: str, body: Secret) -> Secret:
    ...
    async def read_namespaced_secret(self, name: str, namespace: str) -> Secret:
    ...
    async def apply_namespaced_secret(
        self,
        name: str,
        namespace: str,
        body: Secret,
    ...
    async def delete_namespaced_secret(self, name: str, namespace: str) -> Status:
    ...
    async def read_namespaced_service_account(self, name: str, namespace: str) -> ServiceAccount:
    ...
    async def apply_namespaced_service_account(
        self,
        name: str,
        namespace: str,
        body: ServiceAccount,
    ...
    async def delete_namespaced_service_account(self, name: str, namespace: str) -> ServiceAccount:
    ...
    async def create_namespaced_service(self, namespace: str, body: Service) -> Service:
    ...
    async def read_namespaced_service(self, name: str, namespace: str) -> Service:
    ...
    async def proxy_namespaced_service(
        self,
        name: str,
        namespace: str,
        *,
    ...
    async def apply_namespaced_service(
        self,
        name: str,
        namespace: str,
        body: Service,
    ...
    async def read_namespaced_service_status(self, name: str, namespace: str) -> Service:
    ...
    async def delete_namespaced_service(self, name: str, namespace: str) -> Service:
    ...
    async def create_namespaced_endpoints(self, namespace: str, body: Endpoints) -> Endpoints:
    ...
    async def read_namespaced_endpoints(self, name: str, namespace: str) -> Endpoints:
    ...
    async def apply_namespaced_endpoints(
        self,
        name: str,
        namespace: str,
        body: Endpoints,
    ...
    async def delete_namespaced_endpoints(self, name: str, namespace: str) -> Status:
    ...
    async def create_namespaced_pod_template(
        self, namespace: str, body: PodTemplate
    ) -> PodTemplate:
    ...
    async def read_namespaced_pod_template(self, name: str, namespace: str) -> PodTemplate:
    ...
    async def apply_namespaced_pod_template(
        self,
        name: str,
        namespace: str,
        body: PodTemplate,
    ...
    async def apply_namespaced_replication_controller(
        self,
        name: str,
        namespace: str,
        body: ReplicationController,
    ...
    async def create_namespaced_pod(self, namespace: str, body: Pod) -> Pod:
    ...
    async def read_namespaced_pod(self, name: str, namespace: str) -> Pod:
    ...
    async def apply_namespaced_pod(
        self,
        name: str,
        namespace: str,
        body: Pod,
    ...
    def stream_namespaced_pod_log(
        ...
        *,
        ...
        """Stream current or previous Pod logs incrementally."""
    ...
    async def proxy_namespaced_pod(
        self,
        name: str,
        namespace: str,
        *,
    ...
    @asynccontextmanager
    async def connect_namespaced_pod_exec(
        self,
        name: str,
        namespace: str,
        ...
        *,
        ...
        tty: bool = False,
        timeout: float | None = None,
    ) -> AsyncGenerator[AsyncRemoteCommandSession]:
        """Open an asynchronous interactive WebSocket exec session."""
        async with self._client.websocket(
            ...
            yield AsyncRemoteCommandSession(websocket)

    async def execute_namespaced_pod(
        self,
        name: str,
        namespace: str,
        command: Sequence[str],
        *,
        ...
        """Execute a non-interactive command and buffer stdout and stderr."""
        async with self.connect_namespaced_pod_exec(
            name,
            namespace,
            command,
            container=container,
            ...
            return await session.collect(timeout)

    @asynccontextmanager
    async def connect_namespaced_pod_attach(
        self,
        name: str,
        namespace: str,
        *,
        ...
        """Attach asynchronously to a running Pod container over WebSocket."""
        async with self._client.websocket(
    ...
    @asynccontextmanager
    async def connect_namespaced_pod_port_forward(
        self,
        name: str,
        namespace: str,
        port: int,
        *,
        request_id: int = 0,
        timeout: float | None = None,
    ) -> AsyncGenerator[AsyncPortForwardSession]:
        """Open one asynchronous TCP connection to a port in a Pod."""
        async with self._client.websocket(
            ...
            yield await AsyncPortForwardSession.create(
                websocket,
                port,
    ...
    async def replace_namespaced_pod_status(self, name: str, namespace: str, body: Pod) -> Pod:
    ...
    async def read_namespaced_pod_status(self, name: str, namespace: str) -> Pod:
    ...
    async def create_namespaced_pod_binding(
        self, name: str, namespace: str, body: Binding
    ) -> Status:
    ...
    async def create_namespaced_binding(self, namespace: str, body: Binding) -> Status:
    ...
    async def read_namespaced_pod_ephemeral_containers(self, name: str, namespace: str) -> Pod:
    ...
    async def patch_namespaced_pod_ephemeral_containers(
        self,
        name: str,
        namespace: str,
        body: JsonPatch | MergePatch,
    ...
    async def replace_namespaced_pod_ephemeral_containers(
        self,
        name: str,
        namespace: str,
        body: Pod,
    ...
    async def read_namespaced_pod_resize(self, name: str, namespace: str) -> Pod:
    ...
    async def delete_namespaced_pod(self, name: str, namespace: str) -> Pod:
    ...
    def watch_namespaced_pod(
        ...
        *,
        ...
        reconnect: bool = True,
        recover: bool = True,
    ) -> AsyncIterator[WatchEvent[Pod] | WatchBookmark]:
        """Watch Pods in one Namespace with async expired-version recovery."""
        relist: Callable[[], Awaitable[WatchPage]] | None = None
        if recover:

            async def relist_pods() -> PodList:

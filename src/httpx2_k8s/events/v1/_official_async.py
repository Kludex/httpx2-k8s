...
class _OfficialEventsV1AsyncOperations:
    ...
    async def delete_collection_namespaced_event(
        ...
        *,
        ...
        _path = f"/apis/events.k8s.io/v1/namespaces/{resource_name(namespace)}/events"
    ...
    async def delete_namespaced_event(
        ...
        *,
        ...
        _path = f"/apis/events.k8s.io/v1/namespaces/{resource_name(namespace)}/events/{resource_name(name)}"
        params = query_parameters(
            {
                "pretty": pretty,
                "dryRun": dry_run,
    ...
    async def list_event_for_all_namespaces(
        ...
        *,
        ...
        _path = "/apis/events.k8s.io/v1/events"
        params = query_parameters(
            {
        ...
        return await self._client.request(
            "GET",
            _path,
            response_model=EventsV1EventList,
            params=params,
        )
    ...
    async def watch_event_list_for_all_namespaces(
        ...
        *,
        ...
        _path = "/apis/events.k8s.io/v1/watch/events"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    async def watch_namespaced_event_list(
        ...
        *,
        ...
        _path = f"/apis/events.k8s.io/v1/watch/namespaces/{resource_name(namespace)}/events"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,
    ...
    def watch_namespaced_event(
        ...
        *,
        ...
        _path = f"/apis/events.k8s.io/v1/watch/namespaces/{resource_name(namespace)}/events/{resource_name(name)}"
        params = query_parameters(
            {
                "allowWatchBookmarks": allow_watch_bookmarks,
                "continue": continue_token,

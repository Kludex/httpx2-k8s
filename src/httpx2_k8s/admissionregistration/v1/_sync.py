...
class AdmissionRegistrationV1API:
    ...
    def read_mutating_webhook_configuration(self, name: str) -> MutatingWebhookConfiguration:
        return self._client.request(
            "GET",
            (
                "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/"
    ...
    def apply_mutating_webhook_configuration(
        self,
        name: str,
        body: MutatingWebhookConfiguration,
        *,
    ...
    def delete_mutating_webhook_configuration(self, name: str) -> Status:
        return self._client.request(
            "DELETE",
            (
                "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/"
    ...
    def read_validating_webhook_configuration(self, name: str) -> ValidatingWebhookConfiguration:
        return self._client.request(
            "GET",
            (
                "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/"
    ...
    def apply_validating_webhook_configuration(
        self,
        name: str,
        body: ValidatingWebhookConfiguration,
        *,
    ...
    def delete_validating_webhook_configuration(self, name: str) -> Status:
        return self._client.request(
            "DELETE",
            (
                "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/"
    ...
    def read_validating_admission_policy(self, name: str) -> ValidatingAdmissionPolicy:
        return self._client.request(
            "GET",
            (
                "/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/"
    ...
    def read_validating_admission_policy_status(self, name: str) -> ValidatingAdmissionPolicy:
        return self._client.request(
            "GET",
            (
                "/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/"
    ...
    def apply_validating_admission_policy(
        self,
        name: str,
        body: ValidatingAdmissionPolicy,
        *,
    ...
    def delete_validating_admission_policy(self, name: str) -> Status:
        return self._client.request(
            "DELETE",
            (
                "/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/"
    ...
    def apply_validating_admission_policy_binding(
        self,
        name: str,
        body: ValidatingAdmissionPolicyBinding,
        *,
    ...
    def delete_validating_admission_policy_binding(self, name: str) -> Status:
        return self._client.request(
            "DELETE",
            (
                "/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicybindings/"
    ...
    def read_mutating_admission_policy(self, name: str) -> MutatingAdmissionPolicy:
        return self._client.request(
            "GET",
            (
                "/apis/admissionregistration.k8s.io/v1/mutatingadmissionpolicies/"
    ...
    def apply_mutating_admission_policy(
        self,
        name: str,
        body: MutatingAdmissionPolicy,
        *,
    ...
    def delete_mutating_admission_policy(self, name: str) -> Status:
        return self._client.request(
            "DELETE",
            (
                "/apis/admissionregistration.k8s.io/v1/mutatingadmissionpolicies/"
    ...
    def read_mutating_admission_policy_binding(self, name: str) -> MutatingAdmissionPolicyBinding:
        return self._client.request(
            "GET",
            (
                "/apis/admissionregistration.k8s.io/v1/mutatingadmissionpolicybindings/"
    ...
    def apply_mutating_admission_policy_binding(
        self,
        name: str,
        body: MutatingAdmissionPolicyBinding,
        *,
    ...
    def delete_mutating_admission_policy_binding(self, name: str) -> Status:
        return self._client.request(
            "DELETE",
            (
                "/apis/admissionregistration.k8s.io/v1/mutatingadmissionpolicybindings/"

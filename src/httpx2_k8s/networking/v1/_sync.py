...
class NetworkingV1API:
    """Typed Networking v1 API operations."""
    ...
    def read_namespaced_ingress_status(self, name: str, namespace: str) -> Ingress:
    ...
    def create_ip_address(self, body: IPAddress) -> IPAddress:
    ...
    def read_ip_address(self, name: str) -> IPAddress:
    ...
    def delete_ip_address(self, name: str) -> Status:
    ...
    def create_service_cidr(self, body: ServiceCIDR) -> ServiceCIDR:
    ...
    def read_service_cidr(self, name: str) -> ServiceCIDR:
    ...
    def delete_service_cidr(self, name: str) -> DeleteResult[ServiceCIDR]:
    ...
    def read_service_cidr_status(self, name: str) -> ServiceCIDR:
    ...
    def create_namespaced_ingress(self, namespace: str, body: Ingress) -> Ingress:
    ...
    def read_namespaced_ingress(self, name: str, namespace: str) -> Ingress:
    ...
    def delete_namespaced_ingress(self, name: str, namespace: str) -> Status:
    ...
    def create_ingress_class(self, body: IngressClass) -> IngressClass:
    ...
    def read_ingress_class(self, name: str) -> IngressClass:
    ...
    def delete_ingress_class(self, name: str) -> Status:
    ...
    def read_namespaced_network_policy(self, name: str, namespace: str) -> NetworkPolicy:
    ...
    def apply_namespaced_network_policy(
        self,
        name: str,
        namespace: str,
        body: NetworkPolicy,
    ...
    def delete_namespaced_network_policy(self, name: str, namespace: str) -> Status:

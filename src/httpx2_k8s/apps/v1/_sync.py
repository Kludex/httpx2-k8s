...
class AppsV1API:
    """Typed Apps v1 workload-controller operations."""
    ...
    def _read_subresource(
        ...
        *,
        ...
        return self._client.request("GET", f"{path}/{subresource}", response_model=response_model)

    def _replace_subresource(
        self,
        path: str,
        subresource: str,
        body: ResourceT,
    ...
    def read_namespaced_deployment_status(self, name: str, namespace: str) -> Deployment:
        """Read a Deployment through its status subresource."""
        return self._read_subresource(
            self._namespaced_path(namespace, "deployments", name),
            "status",
            response_model=Deployment,
        )
    ...
    def replace_namespaced_deployment_status(
        ...
        *,
        ...
        return self._replace_subresource(
            self._namespaced_path(namespace, "deployments", name),
            "status",
            body,
            response_model=Deployment,
    ...
    def patch_namespaced_deployment_status(
        ...
        *,
        ...
        return self._patch_subresource(
            self._namespaced_path(namespace, "deployments", name),
            "status",
            body,
            response_model=Deployment,
    ...
    def read_namespaced_deployment_scale(self, name: str, namespace: str) -> Scale:
    ...
    def read_namespaced_replica_set_status(self, name: str, namespace: str) -> ReplicaSet:
    ...
    def read_namespaced_replica_set_scale(self, name: str, namespace: str) -> Scale:
    ...
    def read_namespaced_stateful_set_status(self, name: str, namespace: str) -> StatefulSet:
    ...
    def read_namespaced_stateful_set_scale(self, name: str, namespace: str) -> Scale:
    ...
    def read_namespaced_daemon_set_status(self, name: str, namespace: str) -> DaemonSet:
    ...
    def create_namespaced_deployment(self, namespace: str, body: Deployment) -> Deployment:
    ...
    def read_namespaced_deployment(self, name: str, namespace: str) -> Deployment:
    ...
    def apply_namespaced_deployment(
        self,
        name: str,
        namespace: str,
        body: Deployment,
    ...
    def delete_namespaced_deployment(self, name: str, namespace: str) -> Status:
    ...
    def create_namespaced_replica_set(self, namespace: str, body: ReplicaSet) -> ReplicaSet:
    ...
    def read_namespaced_replica_set(self, name: str, namespace: str) -> ReplicaSet:
    ...
    def apply_namespaced_replica_set(
        self,
        name: str,
        namespace: str,
        body: ReplicaSet,
    ...
    def delete_namespaced_replica_set(self, name: str, namespace: str) -> Status:
    ...
    def create_namespaced_stateful_set(self, namespace: str, body: StatefulSet) -> StatefulSet:
    ...
    def read_namespaced_stateful_set(self, name: str, namespace: str) -> StatefulSet:
    ...
    def apply_namespaced_stateful_set(
        self,
        name: str,
        namespace: str,
        body: StatefulSet,
    ...
    def delete_namespaced_stateful_set(self, name: str, namespace: str) -> Status:
    ...
    def create_namespaced_daemon_set(self, namespace: str, body: DaemonSet) -> DaemonSet:
    ...
    def read_namespaced_daemon_set(self, name: str, namespace: str) -> DaemonSet:
    ...
    def apply_namespaced_daemon_set(
        self,
        name: str,
        namespace: str,
        body: DaemonSet,
    ...
    def delete_namespaced_daemon_set(self, name: str, namespace: str) -> Status:
    ...
    def read_namespaced_controller_revision(self, name: str, namespace: str) -> ControllerRevision:
    ...
    def apply_namespaced_controller_revision(
        self,
        name: str,
        namespace: str,
        body: ControllerRevision,
    ...
    def delete_namespaced_controller_revision(self, name: str, namespace: str) -> Status:

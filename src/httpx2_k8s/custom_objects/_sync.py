...
class CustomObjectsAPI:
    ...
    def read_cluster_custom_object_subresource(
        self,
        group: str,
        version: str,
        plural: str,
    ...
    def replace_cluster_custom_object_subresource(
        self,
        group: str,
        version: str,
        plural: str,
    ...
    def patch_cluster_custom_object_subresource(
        self,
        group: str,
        version: str,
        plural: str,
    ...
    def read_namespaced_custom_object_subresource(
        self,
        group: str,
        version: str,
        namespace: str,
    ...
    def replace_namespaced_custom_object_subresource(
        self,
        group: str,
        version: str,
        namespace: str,
    ...
    def patch_namespaced_custom_object_subresource(
        self,
        group: str,
        version: str,
        namespace: str,

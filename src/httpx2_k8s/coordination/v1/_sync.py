...
class CoordinationV1API:
    """Typed Coordination v1 Lease operations."""
    ...
    def create_namespaced_lease(self, namespace: str, body: Lease) -> Lease:
        return self._client.request(
            "POST",
    ...
    def read_namespaced_lease(self, name: str, namespace: str) -> Lease:
        return self._client.request(
            "GET",
            (
                f"/apis/coordination.k8s.io/v1/namespaces/{resource_name(namespace)}"
    ...
    def delete_namespaced_lease(self, name: str, namespace: str) -> Status:
        return self._client.request(
            "DELETE",
            (
                f"/apis/coordination.k8s.io/v1/namespaces/{resource_name(namespace)}"
